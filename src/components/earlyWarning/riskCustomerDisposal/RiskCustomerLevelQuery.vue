    ...
    <div class="content_box" id="contract_content">
        ...
        <div class="edit_module">
            <el-form :inline="true"  class="demo-form-inline" size="small" label-width="105px"> 
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-form-item :label="$t('early.sydj')"> <!-- 收益等级 -->
        ...
        <div class="list_module">
            <div class="table_body">
                <h4>{{$t('early.fxkhdjcxlb')}}</h4><!--风险客户等级查询列表-->
                <el-table
                    ref="multipleTable"
                    :data="tableData"
                    tooltip-effect="dark"
    ...
    export default {
        ...
        data(){
            return {
                ...
                tableData:[
                    {jgh:'000',khxm:'明天你好',zjlx:'不知道',zjhm:'20190320',khfxdj:'无',sydj:"无"}
                ],//风险客户等级查询列表
            }
        },
        mounted(){
