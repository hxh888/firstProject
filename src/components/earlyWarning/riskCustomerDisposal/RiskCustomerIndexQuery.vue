    ...
    <div class="content_box" id="contract_content">
        ...
        <div class="edit_module">
            <el-form :inline="true"  class="demo-form-inline" size="small" label-width="105px"> 
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-form-item :label="$t('early.dq')" >   <!-- 地区 -->
                            <el-input type="text"  v-model="obj.dq" ></el-input >
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item :label="$t('early.khfxdj')"> <!-- 客户风险等级 -->
                            <el-select v-model="obj.khfxdj" style="width:183px;" placeholder="">
                    ...
                    <el-col :span="6">
                        <el-form-item :label="$t('early.khsydj')"> <!-- 客户收益等级 -->
                            <el-select v-model="obj.khsydj" style="width:183px;" placeholder="">
                                <el-option :label="$t('collection.whole')" value="" ></el-option>
                                <el-option label="一级" value="1" ></el-option>
                                <el-option label="二级" value="2" ></el-option>
                                <el-option label="三级" value="3" ></el-option>
        ...
        <div class="list_module">
            <div class="table_body">
                <h4>{{$t('early.fxkhzblb')}}</h4><!--风险客户指标列表-->
                <el-row>
                    <el-col :span="24" style="text-align:right;">
                        <el-button type="primary"  size="small">{{$t('batchCease.dr')}}</el-button><!-- 导入 -->
                    </el-col>
                </el-row>
                <el-table
                    ref="multipleTable"
                    ...
                    <el-table-column  prop="sydj" :label="$t('early.sydj')"  align="center" > </el-table-column><!-- 收益等级 -->
                    <el-table-column  prop="dq" :label="$t('early.dq')"  align="center" > </el-table-column><!-- 地区 -->
                    <!-- 操作 -->
                    <el-table-column :label="$t('Operation')" align="center" min-width="60px" >
                        <template slot-scope="scope">
                            <el-button size="mini" class="edit-btn" @click="seeDialog(scope.row)">
    ...
    export default {
        ...
        data(){
            return {
                ...
                tableData:[
                    {jgh:'000',khxm:'明天你好',zjlx:'不知道',zjhm:'20190320',khfxdj:'无',sydj:'无',dq:''}
                ],//风险客户指标列表
            }
        },
        mounted(){
