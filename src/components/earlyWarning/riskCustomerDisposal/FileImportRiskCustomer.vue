    ...
    <div class="content_box" id="contract_content">
        ...
        <div class="list_module">
            <div class="table_body">
                <h4>{{$t('early.wjdrkhlb')}}</h4><!--文件导入客户列表-->
                <el-row>
                    <el-col :span="4">
                        <el-upload
                            class="upload-demo"
                    ...
                    <el-col :span="20" style="text-align:right;">
                        <el-button size="small">{{$t('early.ydrsj')}}</el-button><!-- 已导入数据 -->
                        <el-button size="small">{{$t('early.sxcfsj')}}</el-button><!-- 筛选重复数据 -->
                        <el-button size="small">{{$t('early.drmbxz')}}</el-button><!-- 导入模板下载 -->
                        <el-button size="small">{{$t('early.plsc')}}</el-button><!-- 批量删除 -->
                        <el-button type="primary"  size="small">{{$t('early.qddr')}}</el-button><!-- 确定导入 -->
                        <el-button type="primary"  size="small">{{$t('early.qbdr')}}</el-button><!-- 全部导入 -->
                    </el-col>
                </el-row>
                <el-table
                    ref="multipleTable"
