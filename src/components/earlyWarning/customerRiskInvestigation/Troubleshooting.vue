    ...
    <div class="content_box" id="contract_content">
        ...
        <div class="edit_module">
            <el-form :inline="true"  class="demo-form-inline" size="small" label-width="80px"> 
                <el-row>
                    ...
                    <el-col :span="6">
                        <el-form-item :label="$t('early.jczt')" >   <!-- 检测状态 -->
                            <el-input type="text"  v-model="obj.jczt" ></el-input >
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
        ...
        <div class="list_module">
            <div class="table_body">
                <h4>{{$t('early.yjkhpclb')}}</h4><!--预警客户排查列表-->
                <el-row>
                    <el-col :span="24" style="text-align:right;">
                        <el-button size="small">{{$t('early.plsc')}}</el-button><!-- 批量删除 -->
                        <el-button size="small" @click="open">{{$t('early.ssgx')}}</el-button><!-- 实时更新 -->
                        <el-button type="primary"  size="small" @click="chooseModal = true">{{$t('early.mxjc')}}</el-button><!-- 模型检测 -->
                    </el-col>
                </el-row>
                <el-table
                    ref="multipleTable"
                    ...
                    <el-table-column  prop="khxm" :label="$t('quota.khxm')"  width="140" align="center" > </el-table-column><!-- 客户姓名 -->
                    <el-table-column  prop="zjlx" :label="$t('remind.documentType')"  align="center" > </el-table-column><!-- 证件类型 -->
                    <el-table-column  prop="zjhm" :label="$t('quota.zjhm')" width="180"  align="center" > </el-table-column><!-- 证件号码 -->
                    <el-table-column  prop="khfxdj" :label="$t('early.khfxdj')"  width="140" align="center" > </el-table-column><!-- 客户风险等级 -->

                    <el-table-column  prop="jcsj" :label="$t('early.jcsj')" width="180" align="center" > </el-table-column><!-- 检测时间 -->
                    <el-table-column  prop="jczt" :label="$t('early.jczt')"  align="center" > </el-table-column><!-- 检测状态 -->
                    <el-table-column  prop="pch" :label="$t('early.pch')"  width="220"  align="center" > </el-table-column><!-- 批次号 -->
                </el-table>
                <el-pagination
        ...
        <!-- 模型检测弹框开始 -->
        <el-dialog title="模型选择" :visible.sync="chooseModal">
                <el-radio v-model="radio" label="1">公安</el-radio>
                <el-radio v-model="radio" label="2">黑名单</el-radio>
                <el-radio v-model="radio" label="3">测试1</el-radio>
                <el-radio v-model="radio" label="4">测试2</el-radio>
                <el-radio v-model="radio" label="5">测试3</el-radio>
            <div slot="footer" class="dialog-footer">
                <el-button @click="chooseModal = false">取 消</el-button>
                <el-button type="primary" @click="chooseModal = false">确 定</el-button>
            </div>
        </el-dialog>
        <!-- 模型检测弹框结束 -->
...
<script>
    export default {
        ...
        methods:{
            ...
            //点击实时更新弹框
            open() {
                this.$alert('未检测'+this.radio+',检测中'+this.radio+'已检测'+this.radio, '实时更新', {
