    ...
    <div class="card table_body">
        ...
        <div class="tab">
            <el-row>
                ...
                <el-col :span="8"><div class="pl30">{{$t('quota.jgh')}}：<span>{{content.jgh}}</span></div></el-col><!--机构号：-->
                <el-col :span="8"><div class="pl30">{{$t('quota.jgmc')}}：<span>{{content.jgmc}}</span></div></el-col><!--机构名称：-->
            </el-row>
            <el-table
                ref="multipleTable"
                :data="tableData"
