<template>
  ...
  <div class="content_box" id="contract_content">
    ...
    <div class="card table_body">
      <h3>{{$t('batchCease.plgnqxlb')}}</h3><!--批量功能取消列表-->
      <el-alert
      ...
      <div class="tab">
        ...
        >
          ...
          <el-table-column  prop="cp" :label="$t('remind.product')" width="140" align="center" > </el-table-column><!-- 产品 -->
          <el-table-column  prop="xfzt" :label="$t('batchCease.xfzt')" width="100" align="center" > </el-table-column><!-- 消费状态 -->
          <el-table-column  prop="qxzt" :label="$t('batchCease.qxzt')" width="100" align="center" > </el-table-column><!-- 取现状态 -->
          <el-table-column  prop="zzzt" :label="$t('batchCease.zzzt')" width="100" align="center" > </el-table-column><!-- 转账状态 -->
          <el-table-column  prop="gxxf" :label="$t('batchCease.gxxf')" width="100" align="center" > </el-table-column><!-- 更新消费 -->
          <el-table-column  prop="gxzz" :label="$t('batchCease.gxzz')" width="100" align="center" > </el-table-column><!-- 更新转账 -->
          <el-table-column  prop="qxzt" :label="$t('batchCease.qxzt')" width="100" align="center" > </el-table-column><!-- 取现状态 -->
    ...
    <!-- 导入弹出框开始 -->
    <el-dialog :title="$t('batchCease.plgnqxdr')" :visible.sync="importDialog" :before-close="cancels"  :close-on-click-modal="false"><!--卡片管理/卡片处置/批量功能取消/导入-->
      ...
      <div class="card border">
        <h3>{{$t('batchCease.plgnqxdrlb')}}</h3><!-- 批量功能取消导入列表 -->
        <div class="cardMain">
          <el-row>
            <el-col :span="8">
              <el-upload
          ...
          <el-button size="mini" @click="delectChecked()" style="margin-top:20px;">{{$t('batchCease.plsc')}}</el-button><!-- 批量删除 -->
          <el-pagination
            @current-change="handleCurrentChange"
            :current-page="obj.pageIndex"
            :page-size="obj.pageSize"
