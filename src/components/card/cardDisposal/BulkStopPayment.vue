<template>
  ...
  <div class="content_box" id="contract_content">
    ...
    <div class="card table_body">
      <h3>{{$t('batchCease.kpzflb')}}</h3><!-- 卡片止付列表-->
      <el-alert
    ...
    <!-- 导入弹出框开始 -->
    <el-dialog :title="$t('batchCease.plzfdr')" :visible.sync="importDialog" :before-close="cancels"  :close-on-click-modal="false"><!--卡片管理/卡片处置/批量止付/导入-->
      ...
      <div class="card border">
        <h3>{{$t('batchCease.kpzfdrlb')}}</h3><!-- 卡片止付导入列表 -->
        <div class="cardMain">
          <el-row>
            <el-col :span="8">
              <el-upload
