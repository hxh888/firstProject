<template>
  ...
  <div class="content_box" id="contract_content">
    ...
    <div class="card">
      ...
      <el-form  :model="card" label-width="135px" size="small" class="demo-form-inline" style="padding:20px 10px;overflow:hidden;">
        <el-col :span="8">
        ...
        <el-col :span="8">
          <el-form-item :label="$t('singleRecovery.dqzhye')" prop="zhzt"><!-- 当前账户余额 -->
            <el-input v-model="card.kxf" readonly placeholder="是/否"></el-input>
          </el-form-item>
        </el-col>
      </el-form>
    ...
    <div class="card">
      <h3>卡片处置</h3><!-- 卡片处置 -->
        <div style="padding:20px 40px;">
          <el-checkbox v-model="checked1" :label="$t('singleRecovery.hfqx')" border></el-checkbox><!-- 恢复取现 -->
          <el-checkbox v-model="checked2" :label="$t('singleRecovery.hfzz')" border></el-checkbox><!-- 恢复转账 -->
          <el-checkbox v-model="checked3" :label="$t('singleRecovery.hfxf')" border></el-checkbox><!-- 恢复消费 -->
          <el-checkbox v-model="checked4" :label="$t('singleRecovery.jzf')" border></el-checkbox><!-- 解止付 -->
          <el-checkbox v-model="checked4" :label="$t('singleRecovery.jqz')" border></el-checkbox><!-- 解欺诈 -->
        </div>
    </div>
    <!-- 卡片处置结束 -->
    <!-- 附件开始 -->
