<template>
  ...
  <div class="content_box" id="contract_content">
    ...
    <div class="card table_body">
      <h3>{{$t('batchCease.pljzflb')}}</h3><!--批量解止付列表-->
      <el-alert
      ...
      <div class="tab">
        ...
        >
          ...
          <el-table-column  prop="xfzt" label="卡片状态" width="100" align="center" > </el-table-column><!-- 卡片状态 -->
          <el-table-column  prop="qxzt" label="更新状态" width="100" align="center" > </el-table-column><!-- 更新状态 -->
    ...
    <!-- 导入弹出框开始 -->
    <el-dialog :title="$t('batchCease.pljzfdr')" :visible.sync="importDialog" :before-close="cancels"  :close-on-click-modal="false"><!--卡片管理/卡片恢复/批量解止付/导入-->
      ...
      <div class="card border">
        <h3>{{$t('batchCease.kpjzfdrlb')}}</h3><!-- 卡片解止付导入列表 -->
        <div class="cardMain">
          <el-row>
            <el-col :span="8">
              <el-upload
