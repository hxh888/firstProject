<template>
  ...
  <div class="content_box" id="contract_content">
    ...
    <div class="card table_body">
      <h3>{{$t('batchCease.plgnhflb')}}</h3><!--批量功能恢复列表-->
      <el-alert
    ...
    <!-- 导入弹出框开始 -->
    <el-dialog :title="$t('batchCease.plgnhfdr')" :visible.sync="importDialog" :before-close="cancels"  :close-on-click-modal="false"><!--卡片管理/卡片恢复/批量功能恢复/导入-->
      ...
      <div class="card border">
        <h3>{{$t('batchCease.plgnhfdrlb')}}</h3><!-- 批量功能恢复导入列表 -->
        <div class="cardMain">
          <el-row>
            <el-col :span="8">
              <el-upload
