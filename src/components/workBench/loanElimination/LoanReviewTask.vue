...
<div class="home" id="loantask">
    <div class="home_main clearfix">
          <div class="home_con clearfix">
              ...
              <!-- 申请件信息和 -->
              <el-form :label-position="$store.state.lang == 'en' ? 'top' : 'right'" :model="loanForm"  ref="loanForm" id="loanForm" size="small"  label-width="150px">
                  <el-row>
                      <el-col :span="8">
                  ...
                  <h5 class="loan_title">{{$t('toDoTasks.handleResult')}}</h5><!-- 审批结果 -->
                  <el-row>
                    <el-col :span="12">
                      <el-form-item  :label="$t('compoundPost.userName')" prop="userName"><!-- 审批人 -->
                        <el-input   v-model="loanForm.userName"  disabled ></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="12">
                      <el-form-item  :label="$t('toDoTasks.approvalOpinions')" prop="handleResult"><!-- 审批意见 -->
                        <!-- <el-input   v-model="loanForm.handleResult"  disabled></el-input> -->
                        <el-select name="" id="" v-model="loanForm.handleResult" disabled placeholder="">
                            <el-option :label="$t('toDoTasks.refuse')" value="0"></el-option><!-- 拒绝 -->
                            <el-option :label="$t('toDoTasks.adopt')" value="1"></el-option><!-- 通过 -->
                            <el-option :label="$t('toDoTasks.return')" value="2"></el-option><!-- 退回 -->
                        </el-select>
                      </el-form-item>
                    </el-col>
                    
                  </el-row>
                  <el-form-item  :label="$t('compoundPost.checkPhoneResult')"  prop="checkExplain" ><!-- 电话核查结果 -->
                      <el-input type="textarea" v-model="loanForm.checkExplain" maxlength="100" show-word-limit  disabled></el-input>
                  </el-form-item>
                  <el-form-item  :label="$t('toDoTasks.approvalNote')"  prop="handleDesc" ><!-- 审批说明 -->
                      <el-input type="textarea" v-model="loanForm.handleDesc" maxlength="100" show-word-limit disabled></el-input>
                  </el-form-item>


              </el-form>
               <h5 class="loan_title">{{$t('compoundPost.ReviewOpinions')}}</h5><!-- 复核意见 -->
               <el-form :label-position="$store.state.lang == 'en' ? 'top' : 'right'" :model="loanForm1" ref="loanForm1"  :rules="$rules.approve" id="loanForm1" size="small"  label-width="150px">

                   <el-row>
                      <el-col :span="12">
                        <el-form-item :label="$t('compoundPost.fhjg')" prop="handleResult"><!-- 复核结果 -->
                          <el-radio-group v-model="loanForm1.handleResult">
                            <el-radio  label="1">{{$t('compoundPost.adopt')}}</el-radio><!-- 通过 -->
                            <el-radio  label="2">{{$t('compoundPost.back')}}</el-radio><!-- 退回 -->
                            <el-radio  label="0">{{$t('compoundPost.refuse')}}</el-radio><!-- 拒绝 -->
                          </el-radio-group>
                        </el-form-item>
                      </el-col>
                      <el-col :span="12">
                  ...
                  <el-form-item  :label="$t('compoundPost.fhsm')"      prop="handleDesc"><!-- 复核说明 -->
                  ...
                  <el-row style="text-align:right" class="mt20">
                        <el-button  @click="resetForm()">{{$t('Reset')}}</el-button><!-- 重置 -->
			                  <!-- <el-button  type="primary"  v-if="loanType=='2'? submitLoanDbdp('loanForm1') : submitLoanSjsh('loanForm1')">提交</el-button> -->
          ...
          <el-dialog :title="title" :visible.sync="dialogFormVisible"  :before-close="cancel" :close-on-click-modal="false">
                        ...
                        <el-col :span="12">
                          ...
                          <el-col :span="12">
                            <el-form-item :label="$t('toDoTasks.zmrhc')" ><!-- 证明人核查 -->
                                 <el-select v-model="detaileForm1.checkCertifier" disabled placeholder="">
                                    <el-option value="" :label="$t('toDoTasks.pleaseChose')"></el-option><!-- 请选择 -->
                                    <el-option 
                ...
                <div v-if="flag==4"> 
                    	<el-table :data="tableData" border style="width: 100%"   size='small' :empty-text="$t('noData')">
                          ...
                          <!--复核岗位-->
                          <el-table-column prop="activityName" :label="$t('compoundPost.ReviewPost')"  align="center" min-width="125px"> </el-table-column>
                          <!--复核人员-->
                          <el-table-column prop="userName" :label="$t('compoundPost.ReviewPersonnel')"  align="center" min-width="160px"> </el-table-column>
                           <!--处理日期-->
                          <el-table-column prop="doneDate" :label="$t('doDate')"  align="center" min-width="145px"> 
                          </el-table-column>
                          <!--处理时间-->
                          <el-table-column prop="doneTime" :label="$t('doTime')"  align="center" min-width="125px">
                          </el-table-column>
                          <!--复核结果-->
                          <el-table-column prop="handleResult" :label="$t('compoundPost.fhjg')"  align="center" min-width="135px"> 
                          </el-table-column>
                          <!--复核说明-->
                          <el-table-column prop="handleDesc" :label="$t('compoundPost.fhsm')"  align="center" min-width="130px"> </el-table-column>
                      </el-table>
                </div>
                ...
                <div v-if="flag==5"> 
                    	<el-table :data="tableData1" border style="width: 100%"   size='small' :empty-text="$t('noData')">
                          ...
                          <el-table-column prop="index" type="index" :label="$t('Serial_number')" align="center" width="135px"></el-table-column>
                          <!-- 申请件编号 -->
                          <el-table-column prop="applyId"  :label="$t('toDoTasks.applyId')" align="center" min-width="150px"></el-table-column>
                          <!--审批岗位-->
                          <el-table-column prop="activityName" :label="$t('toDoTasks.activityName')"  align="center" min-width="215px"> </el-table-column>
                          <!--审批人员-->
                          <el-table-column prop="userName" :label="$t('toDoTasks.userName')"  align="center" min-width="185px"> </el-table-column>
                          <!--处理日期-->
                          <el-table-column prop="doneDate" :label="$t('doDate')"  align="center" min-width="125px"> 
                          </el-table-column>
                          <!--处理时间-->
                          <el-table-column prop="doneTime" :label="$t('doTime')" align="center" min-width="135px">
                          </el-table-column>
                          <!--审批结果-->
                          <el-table-column prop="handleResult" :label="$t('toDoTasks.handleResult')"  align="center" min-width="230px"> 
                          </el-table-column>
                          <!--审批说明-->
                          <el-table-column prop="handleDesc" :label="$t('toDoTasks.approvalNote')"  align="center" min-width="140px"> </el-table-column>
                      </el-table>
                </div>
...
export default {
  ...
  data () {
    return {
      ...
      loanForm:{ 
        ...
        blackInfo:'', //退回
        userName:this.$store.state.loginData.userLogin.userName, //审批人
        handleResult:'', //审批结果
        checkExplain:'', //电话核查
        handleDesc:'' //审批说明
      },
  ...
  watch: {
    'loanForm1.handleResult' (n) {
      if (n != 0) {
        this.loanForm1.handleResultState = ''
      }
    }
  },
  mounted(){
      ...
      initLoanDbdpData(){
        ...
        this.$post(this.$approve + '/handlerSingleSelect',FunMsgData).then(res=>{
          if(res.code=="000000"){
                ...
                if(data.upHit !=null){//退回
                    this.loanForm.userName = data.upHit.userName
                    this.loanForm.handleResult = data.upHit.handleResult
                    this.loanForm.handleDesc = data.upHit.handleDesc
                }
                if(data.phoneInfo !=null){
                    this.detaileForm1 = data.phoneInfo; //查看详情申请件信息
                    this.loanForm.checkExplain =data.phoneInfo.checkExplain
                }

                if(data.blockInfo !=null){//退回
                  this.loanForm.blackInfo = data.blackInfo.handleDesc //退回
                }

                if(data.aftificialInfo !=null){ //转人工原因
                    this.loanForm.aftificialInfo = data.aftificialInfo.handleDesc  //转人工原因
                }
      ...
      submitLoanDbdp(formName){
         this.$refs[formName].validate((valid) => {
           if (valid) {
              ...
              this.disabled = true;
              this.$post(this.$approve + '/HandleSingleCheckCommit',FunMsgData).then(res=>{
                  if(res.code=="000000"){
      ...
      submitLoanSjsh(formName){
          this.$refs[formName].validate((valid) => {
           if (valid) {
              ...
              this.disabled = true;
              this.$post(this.$approve + '/HandleSjshCheckCommit',FunMsgData).then(res=>{
                  if(res.code=="000000"){
                      if (this.$refs[formName]!==undefined) {
                          this.$refs[formName].resetFields();
                      }
              ...
              if(res.code=="000000"){
                    var  data = res.data;
                     ...
                     if(item.handleResult == 4 ){
                        item.handleResult = i18n.t('toDoTasks.zhuanrengong')//转人工原因
      ...
      openDtaile(i){
        ...
        switch(i) {
            ...
            case 3:
                ...
                break;
            case 4:
                this.title = i18n.t('compoundPost.ReviewInfomation')//'复核信息'
